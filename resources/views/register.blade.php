                ...
                <form method="POST" action="{{route('validar-registro')}}">
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="input-line" id="userInput" name="name" value="{{old('name')}}" required>
                            @error('name')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" class="input-line" id="emailInput" name="email" required value="{{old('email')}}">
                            @error('email')
                                <div class="text-danger mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="password" class="input-line" id="passwordConfirmInput" name="password_confirmation" required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="diet" id="dietInput" class="input-line" required>
